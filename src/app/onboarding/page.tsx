...
const CANDIDATE_STEPS: Step[] = [
  ...
  },
  {
    title: "חוברת מיזם",
    description:
      "חוברת לבניית מצגת משקיעים — 13 פרקים שתמלאו לאורך התוכנית. כתבו את תוכן המיזם שלכם בכל פרק.",
    ...
    bullets: [
      ...
      "עקבו אחרי ההתקדמות בחוברת מהדשבורד",
    ],
  },
  {
    title: "הרצאות ומשוב",
...
const MENTOR_STEPS: Step[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "מעקב אחרי ההתקדמות בחוברת המיזם",
      "גישה לכל מה שהחניך/ה כתב/ה בפרקי החוברת",
    ],
  },
  {
    title: "משוב מובנה",
