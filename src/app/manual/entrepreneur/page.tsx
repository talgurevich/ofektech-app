...
export const metadata = {
  title: "מדריך ליזמים — כניסה לפורטל OfekTech",
  description: "איך להתחבר לפורטל OfekTech כיזם/ת",
};
  ...
  return (
    <main className="min-h-screen bg-white">
      <section className="flex flex-col items-center justify-center border-b border-gray-100 py-14 md:py-20 px-6 text-center">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-[#1a2744]">מדריך ליזמים</h1>
...
function Login({ variant }: { variant: "entrepreneur" | "mentor" }) {
  const audienceLine =
    variant === "entrepreneur"
      ? "לאחר שתקבלו מייל הזמנה מצוות OfekTech, תוכלו להתחבר לפורטל."
      : "לאחר שתקבלו מייל הזמנה מצוות OfekTech, תוכלו להתחבר לפורטל.";
    ...
    <section className="space-y-5">
      ...
      <div className="space-y-4">
        <Option
          ...
          body={
            <>
              לחצו על <strong>"כניסה עם Google"</strong> והתחברו עם חשבון Google
              שלכם. לא חייב להיות חשבון Gmail — כל חשבון שמחובר לשירות Google
              (גם חשבון ארגוני) יעבוד.
            </>
          }
        />
        <Option
          ...
          body={
            <>
              ...
              <strong>"שלח לי קישור להתחברות"</strong>. יגיע אליכם מייל עם קישור
              חד-פעמי — לחיצה עליו תכניס אתכם ישירות לפורטל.
            </>
          }
        />
      </div>
